...
// display first and lastName
 for(let i=0;i< workersDetails.length; i++){console.log(workersDetails[i].firstName+" "+workersDetails[i].lastName);}
...
//length of array
 for(let i=0;i< workersDetails.length; i++){console.log(workersDetails.length)}

//Miller Murphy correction to Milner Murphy
workersDetails.forEach(details => {
